...
plt.savefig('./plots/binary_training_curves_intersection_weighted.png', dpi=300, bbox_inches='tight')
print("Training curves saved as './plots/binary_training_curves_intersection_weighted.png'")

# ---------------- Save Model ----------------
model_path = os.path.join(os.getcwd(), 'models', '8binary_face_classifier_xception_early_stopped_intersection_weighted.pth')
